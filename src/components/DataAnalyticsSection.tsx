          ...
          <div className="grid lg:grid-cols-2 gap-0">
            ...
            <div className="p-12 lg:p-16 flex flex-col justify-center">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-8 max-w-lg">
                ...
                business intelligence, and data-driven strategies that fuel informed decision making.
              </p>
              ...
              <div className="relative h-full min-h-[500px]">
                ...
                <div className="absolute top-8 right-8 bg-[#1acb97] rounded-xl p-6 shadow-lg">
                  ...
                  <div className="text-white">
                    <p className="text-xs uppercase tracking-wide mb-1">Data Processed</p>
                    <p className="text-xl font-bold">2.5M+ Records</p>
                  </div>
                </div>
