          ...
          <div className="grid lg:grid-cols-2 gap-0">
            ...
            <div className="p-12 lg:p-16 flex flex-col justify-center">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-8 max-w-lg">
                From web applications to enterprise software, we develop scalable solutions 
                that drive your business forward with cutting-edge technology and expert craftsmanship.
              </p>
              ...
              <div className="relative h-full min-h-[500px]">
                ...
                <div className="absolute top-8 right-8 bg-[#1acb97] rounded-xl p-6 shadow-lg">
                  ...
                  <div className="text-white">
                    <p className="text-xs uppercase tracking-wide mb-1">Projects Delivered</p>
                    <p className="text-xl font-bold">150+ Apps</p>
                  </div>
                </div>
